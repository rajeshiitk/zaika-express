...
CREATE POLICY "all auth all permission" ON "public"."order_items" TO "authenticated" USING (true) WITH CHECK (true);

CREATE POLICY "all auth all permission" ON "public"."orders" TO "authenticated" USING (true) WITH CHECK (true);
